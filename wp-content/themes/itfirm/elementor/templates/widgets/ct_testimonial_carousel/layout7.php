...
<?php if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div id="<?php echo esc_attr($html_id); ?>" class="ct-testimonial ct-testimonial-carousel7 ct-slick-slider slick-dots-style5" <?php if($settings['drap']) : ?>data-cursor-label="<?php echo esc_html('DRAG', 'itfirm'); ?>"<?php endif; ?>>
